...
@section('content')
  <div class="sa4d25">
    <div class="container">
      <div class="row mb-0">
        <div class="col-12">
          <h2 class="st_title"><i class="uil uil-analysis"></i> Ubah Produk {{ $detail->nama_produk }}</h2>
        </div>
      </div>
      <div class="row mt-0">
        <div class="col-12">
          <div class="course_tabs_1">
            <div class="step-app">
              <form action="{{ route(auth()->user()->role.'-produk.update', $detail->id_produks) }}" method="POST"
                                  ...
                                  <optgroup label="{{ $item->nama_kategori }}">
                                    @foreach ($item->subs as $get)
                                      <option value="{{ $get->id_sub_kategori }}"
                                        {{ $detail->sub_kategori_id == $get->id_sub_kategori ? 'selected' : '' }}>
                                        {{ $get->nama_sub_kategori }}
                                      </option>
                                    @endforeach
                                  </optgroup>
                                @endforeach
                            ...
                            <div class="col-lg-12 col-md-12">
                              <div class="ui search focus lbel25 mt-15">
                                ...
                                <div class="ui form swdh30">
                                  <div class="field">
                                    <textarea rows="3" name="deskripsi" id="editor" placeholder="Item description here...">{!! $detail->deskripsi !!}</textarea>
                                  </div>
                                </div>
                            ...
                            <div class="col-lg-5 col-md-6 mb-2">
                              <div class="ui search focus lbel25 mt-15">
                                ...
                                <div class="thumb-item">
                                  <!-- Gambar default -->
                                  <img id="thumbnail-preview" src="{{ asset('thumbnail_produk/' . $detail->thumbnail) }}"
                              ...
                              <div class="ui search focus mt-30 lbel25">
                                ...
                                <div class="ui left icon input swdh19">
                                  <input class="prompt srch_explore" type="text" inputmode="numeric"
                                    placeholder="Rp. ..." name="harga[]" data-purpose="edit-course-title"
                                    maxlength="60" id="main[title]" value="{{ $item->harga }}">
                                </div>
                              ...
                              <div class="ui search focus mt-30 lbel25">
                                ...
                                <div class="ui left icon input swdh19">
                                  <input class="prompt srch_explore" type="text" inputmode="numeric"
                                    ...
                                    maxlength="60" id="main[title]" value="{{ $item->stok }}">
                                </div>
                ...
                <div class="step-footer step-tab-pager mt-4 text-end">
                  <a href="{{ route(auth()->user()->role.'-produk.index') }}" class="btn btn-default pt-2">Cancel</a>
